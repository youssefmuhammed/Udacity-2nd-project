...
function grabToken(newUser) {
    return jsonwebtoken_1["default"].sign({ newUser: newUser }, SECRET_TOKEN);
}
var authintication = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userName, password, newUser, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, database.authintication(userName, password)];
            case 1:
                newUser = _a.sent();
                if (newUser === null) {
