...
var database = new orders_1.orderDatabase();
...
var showOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database.showOrder(req.params.id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database.createOrder(req.body)];
            case 1:
                newOrder = _a.sent();
                res.json(newOrder);
                return [3 /*break*/, 3];
...
var deleteOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var deleteOrder_1, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database.deleteOrder(req.params.id)];
            case 1:
                deleteOrder_1 = _a.sent();
                res.json(deleteOrder_1);
                return [3 /*break*/, 3];
            case 2:
                err_4 = _a.sent();
                res.status(400);
...
var updateOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updateOrder_1, Updatedorder, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
